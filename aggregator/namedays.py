"""Static Czech nameday calendar (official)."""
...
NAMEDAYS = {
    ...
    "06-05": "Dobroslav", "06-06": "Norbert", "06-07": "Iveta, Slavoj", "06-08": "Medard",
    ...
    "07-05": "Cyril, Metoděj", "07-06": "Mistr Jan Hus", "07-07": "Bohuslava", "07-08": "Nora",
    ...
    "10-01": "Igor", "10-02": "Olívie, Oliver", "10-03": "Bohumil", "10-04": "František",
    ...
    "12-05": "Jitka", "12-06": "Mikuláš", "12-07": "Benjamin", "12-08": "Květoslava",
    ...
    "12-25": "1. svátek vánoční", "12-26": "Štěpán", "12-27": "Žaneta", "12-28": "Bohumila",
    "12-29": "Judita", "12-30": "David", "12-31": "Silvestr",
}


def get_nameday_for(month: int, day: int) -> str:
